...
4. **Orientation/window resize**: on `orientationchange` or a window resize while focused, re-capture the baseline after a 300 ms settle delay (keyboard/vv animations). When not focused, baseline is captured fresh on next focus anyway.
